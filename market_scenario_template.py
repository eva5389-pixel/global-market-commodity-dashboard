...
tabs=st.tabs(["🏁 市場結論","📈 價量技術","🌍 全球因子","💧 資金流／法人","🌐 IMF總經","🏭 產業評估","🧮 方法","💱 匯率觀察"])
...
with tabs[3]:
    ...
    st.info("優先使用近20日每日報酬×成交量的加權方向；Yahoo暫未回傳成交量時，自動改用1M價格動能的日均值並標示『價格動能代理』。資金強度是五市場訊號的相對占比，不等同ETF實際申購／贖回金額。")
